...
public class AssociationLine extends LineObj{
	...
	public AssociationLine(Point portSource, Point portTarget) {
		super();
	...
	public void drawShape(Graphics g) {
		...
		g.drawLine(portTarget.x, portTarget.y, (int) xm, (int) ym);
		g.drawLine(portTarget.x, portTarget.y, (int) xn, (int) yn);
